...
class ExcelCustom():
    ...
    def _createfolder_getpath_mainchecks_absolutepath(self,META,MAIN_FOLDER_PATH,SUBFOLDER_NAME_RESULTS):
        ...
        RESULT_PATH = PurePath(MAIN_FOLDER_PATH,SUBFOLDER_NAME_RESULTS,RESULTS_SUBFOLDER_LVL1_LOOKUP_NAME,RESULTS_SUBFOLDER_LVL1_LOOKUP_DATE)
        Path(RESULT_PATH).mkdir(parents=True, exist_ok=True)
        return RESULT_PATH


    def determine_file_name_mainchecks(self,META,MAIN_FOLDER_PATH,SUBFOLDER_NAME_RESULTS):
        ...
        full_path_folder = self._createfolder_getpath_mainchecks_absolutepath(META,MAIN_FOLDER_PATH,SUBFOLDER_NAME_RESULTS)
        version=1
